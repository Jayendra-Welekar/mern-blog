...
const EditProfile = ()=>{
    ...
    const [upadatedProfileImg, setUpdatedProfileImg] = useState(null)
    ...
    const handleImgUpload = async (e) => {
        ...
        let url = null;
        let laodingToast = null

        if(upadatedProfileImg){

            laodingToast = toast.loading("Uploading...")

            e.target.setAttribute("disabled", true)

            const formData = new FormData();
            formData.append("img", upadatedProfileImg);
            ...
            url = response.data.imageUrl.url
        }
    ...
    const handleSubmit = (e) => {
        ...
        if(username.length < 3){
            return toast.error("Username should be atleast three letter long")
        }
        ...
        let laodingToast = toast.loading("Updateing...")
