...
const PublishForm = ()=>{
    ...
    let { setEditorState, blog, blog: { banner, title, tags, content, des }, setBlog } =  useContext(EditorContext)
        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 gap-4 ">
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <input onChange={handleBlogTitleChange} type="text" placeholder="Blog Title" defaultValue={title} className="input-box pl-4" />
